...
export const Formats: (FormatsData | {section: string, column?: number})[] = [
	...
	},
	{
		...
		mod: 'gen8',
		ruleset: ['Standard NatDex', 'OHKO Clause', 'Evasion Moves Clause', 'Species Clause', 'Sleep Clause Mod', 'Mega Rayquaza Clause'],
	...
	},
	{
		...
		banlist: [
			...
			'Zacian', 'Zamazenta', 'Zekrom', 'Arena Trap', 'Battle Bond', 'Moody', 'Power Construct', 'Shadow Tag', 'Baton Pass',
		],
	},
	{
