...
punch: Power is multiplied by 1.2 when used by a Pokemon with the Iron Fist Ability, muliplied by 1.5 when used by a Pokemon with the Way of The Fist Ability.
kick: Power is muliplied by 1.5 when used by a Pokemon with the Kicer Ability.
recharge: If this move is successful, the user must recharge on the following turn and cannot make a move.
reflectable: Bounced back to the original user by Magic Coat or the Magic Bounce Ability.
snatch: Can be stolen from the original user and instead used by another Pokemon using Snatch.
sound: Has no effect on Pokemon with the Soundproof Ability.
gemeffect: Move is not effected by type gems
...
export const BattleMovedex: {[moveid: string]: MoveData} = {
	...
	doublekick: {
		...
		pp: 30,
		priority: 0,
		flags: {contact: 1, protect: 1, mirror: 1, kick: 1, kick: 1},
		multihit: 2,
		secondary: null,
		target: "normal",
		type: "Fighting",
	...
	hiddenpower: {
		...
		basePower: 60,
		category: "Special",
		desc: "This move's type depends on the user's individual values (IVs), and can be any type but Fairy and Normal. Physical if atk > spa.",
		shortDesc: "Varies in type based on the user's IVs.",
		isNonstandard: "Past",
		name: "Hidden Power",
		pp: 15,
		priority: 0,
		flags: {protect: 1, mirror: 1, gemeffect: 1},
		onModifyType(move, pokemon) {
	...
	muddywater: {
		...
		basePower: 90,
		category: "Special",
		desc: "Has a 30% chance to lower the target's accuracy by 1 stage, removes all field effects.",
		shortDesc: "30% chance to lower the foe(s) accuracy by 1, Removes all field effects.",
		name: "Muddy Water",
		pp: 10,
		priority: 0,
		flags: {protect: 1, mirror: 1, nonsky: 1},
